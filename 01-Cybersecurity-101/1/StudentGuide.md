...
In Module 6, Day 3, you will receive these credentials for your first Azure lab environment, Windows. Instructors will demonstrate how set up Azure Lab Services.

All you need to do is log into `labs.azure.com` and you should have immediate access to the new lab environment with your Azure Lab Services dashboard. 
...
Cybersecurity is concerned with the confidentiality, integrity, and availability of data and data systems.
